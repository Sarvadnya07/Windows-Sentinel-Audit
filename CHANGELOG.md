...
- WMI/CIM caching engine (`Cache.psm1`) for `Win32_Process` and `Win32_Service`.
- Audit modules: Process, Network, Service, Signature, and Persistence (Registry, Startup, Tasks).
